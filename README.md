...
### Special thanks
Before we continue, I want to thank [Bogdan Sandu](https://github.com/cornusandu) for creating a script to draw an hexagonal custom hatch. <br />
...
Even though the script is quite different now, I would have take ages to figure this out, and I needed this time for university. <br />
